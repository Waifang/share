 ...
 */
   ...
   // var thunder = require('flying/lib/thunder/thunder'); 
    ...
    var nativeShare = function (cfg, encode) {
        ...
        require(['flying/tool/aio'], function() {
            if (Box.os.android) {
    ...
    var copyLinkTip = function(url) {
        $.when(getShotLink(url)).then(function(shoturl) {
            ...
            require(['flying/share/popup'], function (Popup) {
    ...
    var sinaweibo = {
        ...
        cb: (function () {
            ...
            if (isZbios) {
                ...
                // 普通浏览器
                fn = function (opt) {
                    window.open('http://s.share.baidu.com?url=' + encodeURIComponent(opt.url) + '&to=tsina' + '&title=' + encodeURIComponent(opt.content) + '&pic=' + opt.iconUrl);
                };
            }
            return fn;
        })()
    ...
    Share.prototype = {
        ...
        _initShareList: function () {
            ...
            if (isZbios || isUC || (isQQ && OS.n == 'ios')) {
                $.inArray('more', me.opt.channel) && list.push(more);
            }
        ...
        _sendLog: function (key) {
          ...
          /*  var shareThunder = thunder.create({
                baseParams: {
                    logid: window.sSession.logid,
                    ssid: window.sSession.ssid,
                    logFrom: 'yunying_earth',
                    ct: 1,
                    platform: os,
                    cuid: ''
                }
