 ...
 */
var nativeShare = function (config,elementNode,ele ) {
    ...
    this.desc = config.content || document.title || '';
...
/*
    ...
    this.html = function() {
        ...
        var html ='<div id="nativeShare">'+
            ...
            '<div><p class="cancel">取消</p>'+
            '</div></div></div>'+
            '<div class="copy">'+
                '<div class="mask-layer"></div>'+ 
                '<div class="lianj">'+
                    '<div class="c-share-copytip-content">'+
                        '<div class="c-share-copytip-text">复制下方链接，去粘贴给好友吧：</div>'+
                        '<div class="c-share-copytip-linkwr"><a class="c-share-copytip-link" href="###" target="_blank">' + this.url + '</a><div class="c-share-copytip" href="###" target="_blank">' + this.url + '</div></div>'+
                    '</div>'+
